...
public class MycroftMessagingService extends Service {
    public static final String READ_ACTION =
            "mycroft.ai.mycroftcore_android.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "mycroft.ai.mycroftcore_android.ACTION_MESSAGE_REPLY";
    public static final String CONVERSATION_ID = "conversation_id";
    public static final String EXTRA_VOICE_REPLY = "extra_voice_reply";
    private static final String TAG = MycroftMessagingService.class.getSimpleName();
